 ...
 */
package com.dio.livecoding.ecomerce.payment.event;
...
public class PaymentCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8787853349877867666L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PaymentCreatedEvent\",\"namespace\":\"com.dio.livecoding.ecomerce.payment.event\",\"fields\":[{\"name\":\"checkoutCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]},{\"name\":\"paymentCode\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"}]}]}");
   ...
   */
  public static com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder newBuilder() {
    return new com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder();
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder newBuilder(com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder other) {
    return new com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder(other);
  }
   ...
   * @return A new PaymentCreatedEvent RecordBuilder
   */
  public static com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder newBuilder(com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent other) {
    return new com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.checkoutCode)) {
        this.checkoutCode = data().deepCopy(fields()[0].schema(), other.checkoutCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder setCheckoutCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder clearCheckoutCode() {
      checkoutCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder setPaymentCode(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dio.livecoding.ecomerce.payment.event.PaymentCreatedEvent.Builder clearPaymentCode() {
      paymentCode = null;
